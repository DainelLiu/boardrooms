...
@Component(value="BoardRoomDao")
public class BoardRoomDaoImpl implements IBoardRoomDao {
	...
	public boolean save(BoardRoom boardroom) {
		...
		String returnId = (String) session.save(boardroom);
	...
	public List<Object> list() {
		Session session = sessionFactory.openSession();
		Query query = session.createQuery("from BoardRoom");
	...
	public BoardRoom getById(String id) {
		Session session = sessionFactory.openSession();
		BoardRoom dto = (BoardRoom)session.get(BoardRoom.class, id);
		session.close();
		return dto;
	}
