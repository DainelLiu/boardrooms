...
@Component(value="RolePowerDao")
public class RolePowerDaoImpl implements IRolePowerDao {
	...
	public boolean save(RolePower rolepower) {
		...
		String returnId = (String) session.save(rolepower);
	...
	public List<Object> list() {
		Session session = sessionFactory.openSession();
		Query query = session.createQuery("from RolePower");
	...
	public RolePower getById(String id) {
		Session session = sessionFactory.openSession();
		RolePower dto = (RolePower)session.get(RolePower.class, id);
		session.close();
		return dto;
	}
